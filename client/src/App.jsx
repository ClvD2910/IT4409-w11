...
function App() {
    ...
    const handleStartGame = async (selectedSkinId) => {
        ...
        // Start Phaser immediately, spawn as soon as game is ready
        setIsGameReady(false);
        setGameState('playing');
        setEndlessLoading(0); // Skip countdown, wait for game ready then spawn
    };
