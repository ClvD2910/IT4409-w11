...
const HUD = ({ isArena = false, arenaMode = 'arena' }) => {
    ...
    useEffect(() => {
                ...
                setStats(prev => {
                    ...
                    if (prev.lives !== myPlayer.lives ||
                        ...
                        return {
                            ...
                            // Use max of event-driven count and server-synced count
                            kills: Math.max(prev.kills, myPlayer.kills || 0),
        ...
        const unsubscribe = socket.subscribe((packet) => {
            ...
            // Immediately increment kills when we kill someone
            if (packet.type === 'player_died' && packet.killerId === socket.myId) {
